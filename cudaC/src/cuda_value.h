...
extern __constant__ int d_MIN_X, d_MIN_Y, d_MIN_Z, d_MIN_W;
extern __constant__ int d_MAX_X, d_MAX_Y, d_MAX_Z, d_MAX_W;
extern __constant__ int d_SIZE_X, d_SIZE_Y, d_SIZE_Z, d_SIZE_E, d_SIZE_W;
extern __constant__ int d_sXYZEW, d_sYZEW, d_sZEW, d_sEW, d_sW;
extern __constant__ int d_sXYZE, d_sYZE, d_sZE, d_sE;
extern __constant__ float d_SCALE_TO_INT_X, d_SCALE_TO_INT_Y, d_SCALE_TO_INT_Z;


extern float h_A1,h_P, h_INITIAL_INVESTMENT, h_DELTA_T;
extern __constant__ float d_A1, d_A2, d_R, d_MU, d_SIGMA, d_P, d_INITIAL_INVESTMENT, d_DELTA_T;
extern __constant__ int d_MOTECALO_NUMS;

extern float *d_X, *d_Y, *d_Z, *d_W, *d_V, *d_V_tp1, *d_results;
extern int *d_E;

extern __constant__ float *d_d_X, *d_d_Y, *d_d_Z, *d_d_W, *d_d_V, *d_d_V_tp1, *d_d_results;
extern __constant__ int *d_d_E;
