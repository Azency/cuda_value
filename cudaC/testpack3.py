...
# female
# CUDA_VISIBLE_DEVICES=1 nohup python testpack3.py >> female3_test.log 2>&1 &
initial_l = 0.070422
...
live_list = [0.95508318, 0.9479776, 0.93969821]

# male
# CUDA_VISIBLE_DEVICES=0 nohup python testpack3.py >> male3_test.log 2>&1 &
# initial_l = 0.071479
...
# live_list = [0.938519, 0.93016787, 0.92060485]
