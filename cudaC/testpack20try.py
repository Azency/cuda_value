...
# female
# CUDA_VISIBLE_DEVICES=0 nohup python testpack20.py >> female20_test.log 2>&1 &
initial_l = 0.030759
...
live_list = [0.99320371, 0.99275112, 0.99205837, 0.99139464, 0.99058581, 0.98970493, 0.98867356, 0.98749117, 0.98610283, 0.98447572, 0.98255486, 0.98028799, 0.97760967, 0.9744482, 0.97071873, 0.96632442, 0.96115395, 0.95508318, 0.9479776, 0.93969821]

# male
# CUDA_VISIBLE_DEVICES=0 nohup python testpack20.py >> male20_test.log 2>&1 &
# initial_l = 0.030795
...
# live_list = [0.98919799, 0.98850676, 0.98755648, 0.98662116, 0.98551021, 0.98429417, 0.98286998, 0.98122165, 0.97926787, 0.97695839, 0.97422256, 0.97100599, 0.96725252, 0.96291495, 0.95794281,0.95227777, 0.9458399, 0.938519, 0.93016787, 0.92060485]
