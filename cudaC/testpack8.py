...
# female
# CUDA_VISIBLE_DEVICES=0 nohup python testpack8.py >> female8_test.log 2>&1 &
initial_l = 0.038325
...
live_list = [0.97760967, 0.9744482, 0.97071873, 0.96632442, 0.96115395, 0.95508318, 0.9479776, 0.93969821]
...
# live_list = [0.96725252, 0.96291495, 0.95794281, 0.95227777, 0.9458399, 0.938519, 0.93016787, 0.92060485]
