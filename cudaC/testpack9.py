...
# female
# CUDA_VISIBLE_DEVICES=2 nohup python testpack9.py >> female9_test.log 2>&1 &
initial_l = 0.048924
...
live_list = [0.98028799, 0.97760967, 0.9744482, 0.97071873, 0.96632442, 0.96115395, 0.95508318, 0.9479776, 0.93969821]

# male
# CUDA_VISIBLE_DEVICES=0 nohup python testpack9.py >> male9_test.log 2>&1 &
# initial_l = 0.036846
...
# live_list = [0.97100599, 0.96725252, 0.96291495, 0.95794281, 0.95227777, 0.9458399, 0.938519, 0.93016787, 0.92060485]
