...
# female
# CUDA_VISIBLE_DEVICES=0 nohup python testpack7.py >> female7_test.log 2>&1 &
initial_l = 0.049297
...
live_list = [0.9744482, 0.97071873, 0.96632442, 0.96115395, 0.95508318, 0.9479776, 0.93969821]

# male
# CUDA_VISIBLE_DEVICES=1 nohup python testpack7.py >> male7_test.log 2>&1 &
# initial_l = 0.043863
...
# live_list = [0.96291495, 0.95794281, 0.95227777, 0.9458399, 0.938519, 0.93016787, 0.92060485]
