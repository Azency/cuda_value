...
# female
# CUDA_VISIBLE_DEVICES=0 nohup python testpack14.py >> female14_test.log 2>&1 &
initial_l = 0.032182
...
live_list = [0.98867356, 0.98749117, 0.98610283, 0.98447572, 0.98255486, 0.98028799, 0.97760967, 0.9744482, 0.97071873, 0.96632442, 0.96115395, 0.95508318, 0.9479776, 0.93969821]

# male
# CUDA_VISIBLE_DEVICES=0 nohup python testpack14.py >> male14_test.log 2>&1 &
# initial_l = 0.032614
...
# live_list = [0.98286998, 0.98122165, 0.97926787, 0.97695839, 0.97422256, 0.97100599, 0.96725252, 0.96291495, 0.95794281, 0.95227777, 0.9458399, 0.938519, 0.93016787, 0.92060485]
