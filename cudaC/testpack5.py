...
# female
# CUDA_VISIBLE_DEVICES=1 nohup python testpack5.py >> female5_test.log 2>&1 &
initial_l = 0.054635
...
live_list = [0.96632442, 0.96115395, 0.95508318, 0.9479776, 0.93969821]
...
# live_list = [0.95227777, 0.9458399, 0.938519, 0.93016787, 0.92060485]
