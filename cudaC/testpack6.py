...
# female
# CUDA_VISIBLE_DEVICES=0 nohup python testpack6.py >> female6_test.log 2>&1 &
initial_l = 0.050876
...
live_list = [0.97071873, 0.96632442, 0.96115395, 0.95508318, 0.9479776, 0.93969821]
...
# live_list = [0.95794281, 0.95227777, 0.9458399, 0.938519, 0.93016787, 0.92060485]
