...
CUDA_VISIBLE_DEVICES=4 ncu \
  ...
  --metrics "achieved_occupancy, warp_execution_efficiency, dram__throughput.avg.pct_of_peak_sustained_elapsed, sm__sass_thread_inst_executed_op_fp_fma_pred_on.sum" \
  ./testmain
