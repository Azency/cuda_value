...
# female
# CUDA_VISIBLE_DEVICES=1 nohup python testpack2.py >> female2_test.log 2>&1 &
initial_l = 0.086286
...
live_list = [0.9479776, 0.93969821]

# male
# CUDA_VISIBLE_DEVICES=0 nohup python testpack2.py >> female2_test.log 2>&1 &
# initial_l = 0.086659
...
# live_list = [0.93016787, 0.92060485]
